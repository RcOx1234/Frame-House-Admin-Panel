...
export function SessionExpiredScreen({ onBackToLogin }: Props) {
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-950 px-4 py-12">
      <div className="w-full max-w-md rounded-2xl border border-neutral-800 bg-neutral-900/70 p-8 text-center shadow-xl backdrop-blur-sm">
        <h1 className="text-xl font-semibold tracking-tight text-neutral-100">La sesión ha caducado</h1>
        <p className="mt-2 text-sm text-neutral-500">Por seguridad, necesitas iniciar sesión nuevamente.</p>
        <button
          type="button"
